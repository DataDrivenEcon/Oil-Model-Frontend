        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div>
            ...
            <p className="py-4 text-white text-[18px]">
              ...
              the full potential of oil economics data. <br /> Whether you're an
              experienced oil economist, a research institution, <br /> or an
              industry professional, our comprehensive data sets will empower
              you to <br /> make informed decisions, gain valuable insights, and
