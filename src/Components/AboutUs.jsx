        ...
        <div className='max-w-4xl flex items-center h-auto flex-wrap mx-auto lg:my-0'>
          <div className='w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0'>
            <div className='md:p-12 text-center lg:text-left'>
              ...
              <h1 className='text-3xl font-bold pt-8 lg:pt-0'> Gary Eisen</h1>
              ...
              <p className='pt-8 text-sm'>
                Gary Eisen, Phd, CFA. Dr Eisen has held important positions over
                several decades in the oil industry including chief economist
                for British Petroleum NA, research manager for Louis Dreyfus
                Energy, senior economist for Petroleum Industry Research
                Associates and more recently S&P Global.
              </p>
